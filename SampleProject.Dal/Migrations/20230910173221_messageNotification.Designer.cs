...
namespace SampleProject.Dal.Migrations
{
    ...
    [Migration("20230910173221_messageNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "64971e2e-2472-43c1-ae0b-56b6e709bc2e",
                            ConcurrencyStamp = "44d19ba6-7078-4c19-8918-001740854bd1",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "6ba14965-000e-49c8-87c0-7e10cdcb1a6c",
                            ConcurrencyStamp = "3f6a11ba-d6bd-415b-a5c0-e122f350e9e0",
                            Name = "Member",
            ...
            modelBuilder.Entity("SampleProject.Entities.Concrete.Message", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SampleProject.Entities.Concrete.Notification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SampleProject.Entities.Concrete.Message", b =>
                {
                    b.HasOne("SampleProject.Entities.Concrete.AppUser", "ReceiverUser")
                        .WithMany("Receiver")
                        .HasForeignKey("ReceiverID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SampleProject.Entities.Concrete.AppUser", "SenderUser")
                        .WithMany("Sender")
